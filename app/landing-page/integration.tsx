                ...
                <div className="mx-auto flex flex-col px-6 md:grid md:max-w-5xl md:grid-cols-2 md:gap-12">
                    <div className="order-last mt-3 flex flex-col gap-12 md:order-first">
                        <div className="space-y-6">
                            <h2 className="text-balance text-3xl font-semibold md:text-4xl lg:text-5xl">Create Your Modern Website</h2>
                            <p className="text-muted-foreground">Build a stunning, responsive website with Wheelbox. Perfect for startups, portfolios, or businesses—launch your dream website today!</p>
                            <Button
                                variant="outline"
                                size="sm"
                                asChild>
                        ...
                        <div className="mt-auto grid grid-cols-[auto_1fr] gap-3">
                            ...
                            <blockquote>
                                <p>A powerful landing page boosts your credibility, enhances brand awareness, and drives marketing success.</p>
