...
export function CompareWeb() {
  return (
    <div className="w-full h-[60vh] px-1 md:px-8 flex items-center justify-center [perspective:800px] [transform-style:preserve-3d]">
      ...
      >
        <Compare
          firstImage="https://vscode.github.net.cn/assets/docs/nodejs/reactjs/bracket-matching.png"
          secondImage="https://www.nexilaunch.com/templates/prostack.webp"
